...
if(!isset($size)) $size = $is_wysiwyg ? 14 : 32;
if(!isset($weight)) $weight = $is_wysiwyg ? 300 : 400;
if(!isset($color)) $color = false;
...
?>
<<?php echo e($type); ?> class="<?php echo e(implode(' ', $classes)); ?>"><?php echo $text; ?></<?php echo e($type); ?>><?php /**PATH /app/wp-content/themes/theme/resources/views/elements/text.blade.php ENDPATH**/ ?>