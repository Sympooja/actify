...
{	
	...
	$license_request_url = "https://www.actify.com/license_requestor/sf3.php?partner_id=" . rawurlencode($partner_id);
...
function actify_get_upgrade_license_request_url($seat_id, $salutation, $first_name, $last_name, $company, $phone, $email, $street1, $street2, $city, $state, $zip_code, $country)
{
	...
	$license_request_url = "https://www.actify.com/license_requestor/sf2.php?type=sf84_upgrade&partner_id=" . rawurlencode($partner_id);
