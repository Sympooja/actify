...
@section('content')
    <section>
                ...
                <div class="row">
                    <div class="col-md-6 home-section-1-left-content pl-0">
                        <div class="home-section-1-left-banner" style="background-image: url('<?php the_field('section_1_left_image'); ?>');">
                            ...
                            <div class="home-section-1-left-description" id="blue-gear">
                    ...
                    <div class="row home-section-2-description">
                        <div class="col-md-6 ml-auto home-section-2-right">
                            ...
                            <div class="row home-section-2-content">
                                <div class="col-md-6 col-6 home-section-2-content-left">
                                    <?php the_field('section_2_left_content'); ?>
                                </div>
                                <div class="col-md-6 col-6 home-section-2-content-right">
        ...
        <div class="home-section-3" id="super">
            <div class="container">
                <div class="row home-section-3-description">
                    <div class="col-md-12 home-section-3-title">
                        ...
                        if ($link) :
                            ...
                            $link_target = $link['target'] ? $link['target'] : '_self';
                        ?>
                        <div class="home-section-6-button home-section-2-button home-section-3-button"
                ...
                <div class="row home-section-3-repeater">
                    ...
                    <div class="col-md-4 home-section-3-card">
                        <div class="home-section-3-image">
                            ...
                            <?php $fea = get_sub_field("section_3_repeater_option_button");
                            if ($fea == "Image") { ?>
                            ...
                            <a href="<?php echo esc_url($link_url); ?>">
                                <video autoplay muted loop playsinline preload="auto" id="myVideo"
                                    poster="<?php the_sub_field('section_3_repeater_video'); ?>">
                                    <source src="<?php the_sub_field('section_3_repeater_video'); ?>" type="video/mp4">
                                </video>
                            </a>
                            <?php }  ?>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-sm-7 home-section-5-content">
                                    <div class="home-section-5-testimonial-description">
            ...
            <div class="home-section-7-description">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-9 col-md-12 col-sm- mx-auto">
                            <div class="row home-section-7-image-repeater">
                                ...
                                <div class="col-md-4 home-section-7-repeater-content">
                                    <a href="<?php the_sub_field('section_7_repeater_button_url'); ?>">
                                        <div class="home-section-7-images">
                                            <img src="<?php the_sub_field('section_7_repeater_image'); ?>" alt="">

                                            <div class="home-section-7-cont">
                                                <?php
                                            if (get_sub_field('section_7_repeater_button')) : ?>
                                                <div class="home-section-7-repeater-button">
                                                    <span>
                                                        <?php the_sub_field('section_7_repeater_button'); ?>
                                                    </span>
                                                </div>
                                                <?php endif; ?>
                                                <h3><?php the_sub_field('section_7_repeater_title'); ?></h3>
                                            </div>
                                        </div>
                                    </a>
                                </div>
