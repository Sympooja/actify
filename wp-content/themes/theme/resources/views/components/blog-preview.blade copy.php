...
<div class="col-md-6 blog-feature-posts">
    <a href="{{ $article['url'] }}"
        class="col-span-12 flex items-center @if ($layout === '1') {{ $cols }} @elseif($layout === '2') flex-row @elseif($layout === '3') flex-col {{ $cols }} @endif">
        <div
        ...
        <div
            class="flex-auto flex flex-col w-full px-6 py-10 @if ($layout != '2') rounded-br-lg rounded-bl-lg @endif">
            <div>
                @if ($layout === '3')
