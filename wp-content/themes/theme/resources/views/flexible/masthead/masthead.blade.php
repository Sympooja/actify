<section class="header-banner-section" data-type="masthead" data-layout="{{ $layout }}" data-aos=mixed_appear
    data-aos-once=true>
        ...
        <div class="container {{ $layout === '1' ? 'py-8 md:py-32' : 'py-8 md:py-12' }}">
            <div class="md:flex items-center md:flex-row-reverse">
                <div class="md:w-[40%] pb-10 md:pb-0">
                    ...
                    <a href="{{ $video_modal }}" class="glightbox relative block hover:video-button min-h-[200px]">
    ...
    <div
        class="container-outer {{ $layout !== '6' ? 'text-black' : '' }} {{ $layout === '5' ? 'md:mb-[40px] lg:mb-[90px] xl:mb-[105px]' : '' }}">
        <div class="container py-8 md:py-12">
            <div class="md:flex {{ $form_embed ? '' : 'items-center' }}">
                ...
                <div class="flex-1">
                    @if ($layout === '3')
                    <div class="p-6 bg-white text-grey shadow-default" style="background-color: #f6f6f6 !important;">
    ...
    <div class="container-outer relative">
        ...
        <span class=" absolute inset-0 z-4 opacity-50 header-banner-fade"></span>
        ...
        @else
        <span class="absolute inset-0 z-4 opacity-70"></span>
        <span class="absolute inset-0">@img($image['ID'], 'w-full h-full object-cover')</span>
        @endif
        <div
            class="container header-banner-content relative {{ $add_looping_video && $video_looping ? 'py-24 md:py-48' : 'py-16 md:py-36' }} z-20">
            <div class="md:flex items-center md:flex-row-reverse">
                <div class="flex-1 max-w-3xl mr-auto">
                    @include('flexible.masthead.copy')
                </div>
            </div>
        </div>
