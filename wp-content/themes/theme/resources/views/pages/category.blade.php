...
@section('content')
    ...
    <div>
        <section data-type="masthead" data-layout="{{ $layout }}" class="py-[60px] pb-0">
            <div class="container">
                        ...
                        @foreach (array_slice($articles, 0, 2) as $article)
                            <div class="swiper-slide grid grid-cols-12 ">
                                <div class="col-span-12 md:col-span-6 h-full">
                                    @img($article['featured_image_id'], 'large w-full h-full object-cover rounded-tr-lg rounded-tl-lg rounded-bl-md rounded-br-md')
                                </div>
                                <a href="{{ $article['url'] }}"
    ...
    <section class="py-16 md:py-20 mb-16 md:mb-20">
