...
<section>
    <div class="home-page-5c-section">
        ...
        <?php $fea = get_field("section_1_option_button");
        if ($fea == "Show") { ?>
        ...
        <?php $fea = get_field("section_2_option_button");
        if ($fea == "Show") { ?>
        ...
        <div class="homepage-5c-repeater-section">
            <?php $cn = 0; if (have_rows('section_3_repeater')) : ?>
            ...
            <div class="<?php echo $cn % 2 == 0 ? 'cn-left' : 'cn-right ' ?>">
                    ...
                    <div class="container">
                        <div class="row homepage-5c-section-3-description">
                            <div class="col-md-6 homepage-5c-section-3-left">
                                <h2><?php the_sub_field('section_3_title'); ?></h2>
                                <?php the_sub_field('section_3_content'); ?>

                                <?php
                            $link = get_sub_field('section_3_button');
                            if ($link) :
                                $link_url = $link['url'];
                            ...
                            ?>
                                ...
                                <div class="row homepage-5c-section-3-repeater">
                                    <?php if (have_rows('section_3_repeater_content')) : ?>
                                    <?php while (have_rows('section_3_repeater_content')) : the_row(); ?>
                            ...
                            <div class="col-md-6 homepage-5c-section-3-right">
                                <img src="<?php the_sub_field('section_3_image'); ?>" alt="">
                                <div class="homepage-5c-section-3-video">
                                    <video autoplay muted loop playsinline preload="auto" name="media" id="myVideo">
                                        <source src="<?php the_sub_field("section_3_video_url"); ?>" type="video/mp4">
                                    </video>
                                </div>
                            </div>
                        </div>
                ...
                <div class="homepage-5c-section-4">
                    <div class="container">
                        <div class="row homepage-5c-section-3-description">
                            <div class="col-md-6 homepage-5c-section-4-right homepage-5c-section-3-right">
                                <img src="<?php the_sub_field('section_3_image'); ?>" alt="">
                                <div class="homepage-5c-section-3-video">
                                    <video autoplay muted loop playsinline preload="auto" name="media" id="myVideo">
                                        <source src="<?php the_sub_field("section_3_video_url"); ?>" type="video/mp4">
    ...
    <?php $fea = get_field("logo_repeater_option_button");
    if ($fea == "Show") { ?>
    <div class="home-section-4">
        <div class="container">
            ...
            <div class="home-section-4-slider">
    ...
    <?php $fea = get_field("section_5_option_button");
    if ($fea == "Show") { ?>
    ...
    <?php $fea = get_field("section_6_option_button");
    if ($fea == "Show") { ?>
    <div class="home-section-6 home-section-7"
        style="background-image: url('<?php the_field("section_6_background_image"); ?>');">
    ...
    <?php $fea = get_field("section_7_option_button");
    if ($fea == "Show") { ?>
    <div class="home-section-7" style="background-image: url('<?php the_field('section_7_background_image'); ?>');">
        <div class="home-section-7-description">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto home-section-7-content">
                    ...
                    <div class="col-lg-6 col-md-8 mx-auto">
                        <div class="row home-section-7-image-repeater">
                            <?php if (have_rows('section_7_images_repeater')) : ?>
                            <?php while (have_rows('section_7_images_repeater')) : the_row(); ?>
                            <div class="col-4 home-section-7-images-rep">
                                <div class="home-section-7-images">
                                    <a href="<?php the_sub_field('section_7_images_url'); ?>">
                                        <img src="<?php the_sub_field('section_7_images'); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                            <?php endwhile; ?>
