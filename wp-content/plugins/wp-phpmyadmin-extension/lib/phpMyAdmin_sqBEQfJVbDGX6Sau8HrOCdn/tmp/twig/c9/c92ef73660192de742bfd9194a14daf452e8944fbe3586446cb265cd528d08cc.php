...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/nas/content/live/actify/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_sqBEQfJVbDGX6Sau8HrOCdn/templates/database/export/index.twig");
    }
}
